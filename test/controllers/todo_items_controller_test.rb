...
class TodoItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post todo_items_url, params: { todo_item: { content: @todo_item.content, priority: @todo_item.priority, status: @todo_item.status, todo_list_id: @todo_item.todo_list_id } }
    end
  ...
  test "should update todo_item" do
    patch todo_item_url(@todo_item), params: { todo_item: { content: @todo_item.content, priority: @todo_item.priority, status: @todo_item.status, todo_list_id: @todo_item.todo_list_id } }
